...
export {signUpEmail, orderEmail, orderNotificationEmail}
...
const orderEmail = (req,res,next)=>{
  try{
    ...
    let mailOptions = {
      ...
      html: `<b>Hello ${usersName}, thanks for purchasing from Sikra Jewelry</b><br>Look at the order here: <a href = 'http://www.sikrajewelry.com/orders/${orderId}'>${orderId}<a/>` // html body
    };
    transporter.sendMail(mailOptions, function(error, info){
      if(error){
          return console.log(error);
